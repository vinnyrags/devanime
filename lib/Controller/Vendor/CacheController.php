...
//        });
    ...
    public function init()
    {
        ...
        foreach ((array) apply_filters('devanime/cache_clear-hooks', $this->clear_cache_hooks) as $hook) {
            add_action($hook, [__CLASS__, 'flagCacheClear']);
        }
        $this->cache_clear_ttl = apply_filters('devanime/cache_clear-ttl', static::DEFAULT_CACHE_CLEAR_TTL);
